...
public class PageUtils {
	...
	private void initPage() {
		...
		page += "<input type='button' class='btn btn-success' value='首页' onclick='page(1)' >";
		page += "<input type='button' class='btn btn-success' value='上一页' onclick='page(" + prevPage + ")' >";
		page += "<input type='button' class='btn btn-success' value='下一页' onclick='page(" + nextPage + ")' >";
		page += "<input type='button' class='btn btn-success' value='尾页' onclick='page(" + lastPage + ")' >";
	}
